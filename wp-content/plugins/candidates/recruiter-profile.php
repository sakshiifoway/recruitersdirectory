...
?>
<link type="text/css" href="<?php echo WP_PLUGIN_URL; ?>/candidates/style-admin.css" rel="stylesheet" />
<script type='text/javascript' src='<?php echo WP_PLUGIN_URL; ?>/candidates/validation.js'></script>
<div class="wrap">
<div style="width:100%; float:left;">  
  ...
  <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data" name="DealerSaleFrm">
    ...
    <input type='button' name="back" value='Back' class='button button-primary button-large' style="margin-top:-10px;margin-bottom:-10px;" onclick="window.location='<?php echo bloginfo('home');?>/wp-admin/admin.php?page=candidates'">
   </td>
                </tr>
              <TR> 
            ...
            <tr>
              <td colspan="2" align="center"><input type='button' name="back" value='Back' class='button button-primary button-large' onclick="window.location='<?php echo bloginfo('home');?>/wp-admin/admin.php?page=candidates'"></td>
            </tr>
          </table></td>
      </tr>
    </table>
