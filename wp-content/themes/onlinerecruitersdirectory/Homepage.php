...
if($_REQUEST['hdn_conatct'] == "1")
{
	...
	echo $content;
	exit;
	sendmail($to,$subject,$content,$from);
        ...
        <div class="caption-inner">
          ...
          <div class="search-form">
            <ul>
              ...
              <li>
                <button value="Go">Go<img src="<?php echo get_template_directory_uri(); ?>/images/go-arrow.png"/></button>
              </li>
            </ul>
          </div>
        </div>
...
<section class="hiri-manager-main">
  ...
  <div class="mngr_mid">
    ...
    <div class="mngr_form">
      <form name="homeContactFrm" id="homeContactFrm" method="post" action="<?php echo bloginfo('home');?>">
        <div class="fr_fild">
          <input type="input" class="input_fld" name="name" id="name" placeholder="NAME*" >
        </div>
        <div class="fr_fild">
          <input type="input" class="input_fld" name="phone" id="phone" placeholder="PHONE*" >
        </div>
        <div class="fr_fild">
          <input type="input" class="input_fld" name="email" id="email" placeholder="EMAIL*" >
        </div> 
        <div class="fr_fild">
        ...
        <br clear="all">
        <center>
        	<input type="hidden" name="hdn_conatct" id="hdn_conatct" value="0" /><!--onclick="return CheckHomeContact();"-->
          <input name="submit_contact" class="btn_cont" value="Contact Now" type="submit" >
        </center>
      </form>
    </div>
  </div>
